...
int main (int argc, char** argv)
{
  ...
  std::string filename = "/home/haeyeon/Lidar/RIST_data/1.pcd";
  ...
  //add descriptors
  pcl::PointCloud<pcl::SHOT352>::Ptr descriptors (newpcl::PointCloud<pcl::SHOT352>()); 
  ...
  describer.setSearchSurface (point_cloud); 
